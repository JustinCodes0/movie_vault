...
function displayMovie(movie) {
    ...
    topDiv.innerHTML = `
        <div style="height: 23rem; position: relative;">
            ...
            />
            <div id="dropdown-menu-${movie.title}" style="display: none; position: absolute; top: 100%; right: 0; background: white; border: 1px solid #ccc; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); z-index: 1000;">
